...
//------------------------------------------------------------------------------------------------------------
PanelState::PanelState(int save_x, int save_y, int save_index , int save_current )
	: save_X(save_x), save_Y(save_y), save_Index(save_index), save_Current(save_current)
{
